...
import com.example.nilanjan.viewfinder.ui.CameraSourcePreview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mGraphicOverlay.view = mGraphicOverlay;
        Log.d(TAG, "onCreate: " + Patterns.WEB_URL);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!textRecognizer.isOperational()) {
            Log.d(TAG, "createCameraSource: Need to download dependencies");
            ...
            if (hasLowStorage) {
                Toast.makeText(context, "You have low storage", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "createCameraSource: Low Storage");
            }
        }
        mCameraSource = new CameraSource
                .Builder(context, textRecognizer)
